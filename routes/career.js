...
router.get('/', async (req, res) => {
  res.render('career', { title: 'Scalelot - Treat With Technologies', page : 'career' });
});
                        ...
                        if (message && message != '') {
                          if (cv && cv != '') {
                            ...
                            if (checkExisting == null) {
                              ...
                              sendSmtpEmail.subject = 'Application for the Post - ' + selectedPosition;
                                                               ...
                                                               <tbody style="padding: 25px;">
                                                                  ...
                                                                  <tr>
                                                                     <td style="text-align: center; width: 100%; padding: 30px 0; padding-top: 15px; border-top: 0.5px solid #ddd;">
                                                                        ...
                                                                        <p style="font-size: 10px; font-weight: 400; color: #fff; margin-bottom: 0; margin-top: 5px;  font-family: 'Helvetica Neue';">Copyright © 2023 by Scalelot Technologies . All Rights Reserved</p>
                                                                     </td>
                                                                  </tr>
                                                               </tbody>
                                                            </table>
                              ...
                              sendSmtpEmail.sender = { "name": first_name + ' ' + middle_name + ' ' + last_name, "email": email };
                              sendSmtpEmail.to = [
                                { "email": process.env.SIB_EMAIL_ID, "name": "Scalelot Technologies" },
                                { "email": "hr.scalelot@gmail.com", "name": "Scalelot Technologies HR" }
                              ];
                              sendSmtpEmail.replyTo = { "email": email, "name": first_name + ' ' + middle_name + ' ' + last_name };
                              sendSmtpEmail.params = { "subject": 'Application for the Post - ' + selectedPosition };
