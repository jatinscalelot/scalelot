...
router.post('/', async (req, res) => {
  ...
  if (name && name.trim() != '' && email && email.trim() != '' && (/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(email))) {
    ...
    if (checkExisting == null) {
      ...
      sendSmtpEmail.subject = name + ' - Contacted - for - ' + subject + ' - Service';
      sendSmtpEmail.htmlContent = "<html><body><h3>" + name + "</h3><br/><h5>" + email + "</h5><br/><h5>" + contrycode + phone + "</h5><br/><h5>" + message + "</h5></body></html>";
      ...
      apiInstance.sendTransacEmail(sendSmtpEmail).then(function (data) {
        ...
        sendSmtpEmailTouser.htmlContent = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
        ...
        sendSmtpEmailTouser.sender = { "name": "Scalelot Technologies", "email": process.env.SIB_EMAIL_ID };
        sendSmtpEmailTouser.to = [
